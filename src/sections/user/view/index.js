...
export { default as UserClinetListView } from './user-clientInactivelist-view';
...
export { default as UserCompanyyView } from './user-companyInactivlist-view';
...
export { default as UserClientDeleteView } from './user-client_deletion-view';
