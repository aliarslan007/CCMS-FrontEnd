...
import UserTableRow from '../user-table-row-client_deletion';
...
const TABLE_HEAD = [
  ...
  { id: 'compnay_name', label: 'Company Name', width: 180 },
...
export default function UserClientDeleteView({ moduleName }) {
  ...
  return (
    <>
      <Container maxWidth="">
        <CustomBreadcrumbs
          heading="Client Contact Marked For Deletion"
...
UserClientDeleteView.propTypes = {
