...
export const _emails = [
  ...
  'admin@admin.com',
  'admin@admin.com',
  // 'softwarecompany@hotmail.com',
  // 'softwarecompany@hotmail.com',
  'JHON',
  'JHON',
  'JON',
  'DAVID',
  'softwarecompany@hotmail.commmm',
  // 'softwarecompany@hotmail.com',
  // 'softwarecompany@hotmail.com',
];

export const _cellphone = [
  '454-4545',
  '9486-343',
  '9498-343',
  '9478-343',
...
export const _roles = ['HR Manager', 'SALES REPRESENTATIVE', 'SALES MANAGER'];
